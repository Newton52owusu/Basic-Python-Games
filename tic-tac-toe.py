...
# create a matrix to store the buttons in... makes easy to check for victory
...
def check_for_victory():
    ...
    won = (
        ...
        (board[0][0].text == name and board[0][1].text == name and board[0][2].text == name) or  # across the left side
        (board[1][0].text == name and board[1][1].text == name and board[1][2].text == name) or  # across the middle
        (board[2][0].text == name and board[2][1].text == name and board[2][2].text == name) or  # across the right side
    ...
    if won:
        ...
        t =Text(f"player\n{name}\won!", scale=3, origin=(0,0), background=True)
